...
type backup struct {
	...
	backupSourceRef []kahuapi.ResourceObjectReference
}
...
func newBackup(kubeClient kubernetes.Interface,
	kahuClient clientset.Interface,
	dynamicClient dynamic.Interface,
	backupSourceRef ...kahuapi.ResourceObjectReference) (Interface, error) {
	return &backup{
...
func (b *backup) ensureVBCWithBackupSourceRef(backupName string,
	snapshotRef kahuapi.ResourceObjectReference) error {
	kahuVolSnapshot, err := b.kahuClient.KahuV1beta1().
		Snapshots().
