	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KahuV1().Providers().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KahuV1().Providers().Watch(context.TODO(), options)
			},
		},
		&kahuv1.Provider{},
		resyncPeriod,
...
func (f *providerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kahuv1.Provider{}, f.defaultInformer)
}

func (f *providerInformer) Lister() v1.ProviderLister {
	return v1.NewProviderLister(f.Informer().GetIndexer())
}
