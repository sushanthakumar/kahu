...
type VolumeBackupContentInformer interface {
	...
	Lister() v1.VolumeBackupContentLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KahuV1().VolumeBackupContents().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KahuV1().VolumeBackupContents().Watch(context.TODO(), options)
			},
		},
		&kahuv1.VolumeBackupContent{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *volumeBackupContentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kahuv1.VolumeBackupContent{}, f.defaultInformer)
}

func (f *volumeBackupContentInformer) Lister() v1.VolumeBackupContentLister {
	return v1.NewVolumeBackupContentLister(f.Informer().GetIndexer())
}
