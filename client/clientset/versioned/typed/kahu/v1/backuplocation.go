...
type BackupLocationInterface interface {
	Create(ctx context.Context, backupLocation *v1.BackupLocation, opts metav1.CreateOptions) (*v1.BackupLocation, error)
	Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error
	Get(ctx context.Context, name string, opts metav1.GetOptions) (*v1.BackupLocation, error)
	List(ctx context.Context, opts metav1.ListOptions) (*v1.BackupLocationList, error)
...
func newBackupLocations(c *KahuV1Client) *backupLocations {
...
func (c *backupLocations) Get(ctx context.Context, name string, options metav1.GetOptions) (result *v1.BackupLocation, err error) {
	result = &v1.BackupLocation{}
	err = c.client.Get().
...
func (c *backupLocations) List(ctx context.Context, opts metav1.ListOptions) (result *v1.BackupLocationList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1.BackupLocationList{}
	err = c.client.Get().
		Resource("backuplocations").
...
func (c *backupLocations) Watch(ctx context.Context, opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *backupLocations) Create(ctx context.Context, backupLocation *v1.BackupLocation, opts metav1.CreateOptions) (result *v1.BackupLocation, err error) {
	result = &v1.BackupLocation{}
	err = c.client.Post().
		Resource("backuplocations").
		VersionedParams(&opts, scheme.ParameterCodec).
...
func (c *backupLocations) Delete(ctx context.Context, name string, opts metav1.DeleteOptions) error {
...
func (c *backupLocations) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
