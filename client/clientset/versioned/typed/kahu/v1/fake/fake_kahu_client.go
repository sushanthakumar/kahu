...
import (
	v1 "github.com/soda-cdm/kahu/client/clientset/versioned/typed/kahu/v1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeKahuV1 struct {
	*testing.Fake
}

func (c *FakeKahuV1) Backups() v1.BackupInterface {
	return &FakeBackups{c}
}

func (c *FakeKahuV1) BackupLocations() v1.BackupLocationInterface {
	return &FakeBackupLocations{c}
}

func (c *FakeKahuV1) Providers() v1.ProviderInterface {
	return &FakeProviders{c}
}

func (c *FakeKahuV1) Restores() v1.RestoreInterface {
