...
var backupsResource = schema.GroupVersionResource{Group: "kahu.io", Version: "v1", Resource: "backups"}

var backupsKind = schema.GroupVersionKind{Group: "kahu.io", Version: "v1", Kind: "Backup"}

// Get takes name of the backup, and returns the corresponding backup object, and an error if there is any.
func (c *FakeBackups) Get(ctx context.Context, name string, options v1.GetOptions) (result *kahuv1.Backup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootGetAction(backupsResource, name), &kahuv1.Backup{})
	if obj == nil {
		return nil, err
	}
...
func (c *FakeBackups) List(ctx context.Context, opts v1.ListOptions) (result *kahuv1.BackupList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootListAction(backupsResource, backupsKind, opts), &kahuv1.BackupList{})
	if obj == nil {
		return nil, err
	}
	...
	list := &kahuv1.BackupList{ListMeta: obj.(*kahuv1.BackupList).ListMeta}
	for _, item := range obj.(*kahuv1.BackupList).Items {
...
func (c *FakeBackups) Create(ctx context.Context, backup *kahuv1.Backup, opts v1.CreateOptions) (result *kahuv1.Backup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootCreateAction(backupsResource, backup), &kahuv1.Backup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*kahuv1.Backup), err
...
func (c *FakeBackups) Update(ctx context.Context, backup *kahuv1.Backup, opts v1.UpdateOptions) (result *kahuv1.Backup, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateAction(backupsResource, backup), &kahuv1.Backup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*kahuv1.Backup), err
...
func (c *FakeBackups) UpdateStatus(ctx context.Context, backup *kahuv1.Backup, opts v1.UpdateOptions) (*kahuv1.Backup, error) {
	obj, err := c.Fake.
		Invokes(testing.NewRootUpdateSubresourceAction(backupsResource, "status", backup), &kahuv1.Backup{})
	if obj == nil {
		return nil, err
	}
	return obj.(*kahuv1.Backup), err
...
func (c *FakeBackups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewRootDeleteAction(backupsResource, name), &kahuv1.Backup{})
	return err
}
