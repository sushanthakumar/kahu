...
import (
	...
	"github.com/soda-cdm/kahu/providers/lvmprovider/server/options"
)

const (
	defaultProviderName    = "local.backup.openebs.io"
	defaultProviderVersion = "v1"
)

type lvmServer struct {
	ctx         context.Context
...
func NewVolumeBackupServer(ctx context.Context,
	...
	clientFactory := client.NewFactory("LVM", serviceOptions.KubeClientOptions.Config)
...
func (server *lvmServer) GetProviderInfo(
	ctx context.Context,
...
func (server *lvmServer) GetProviderCapabilities(
	_ context.Context,
...
func (server *lvmServer) Probe(ctx context.Context, probeRequest *pb.ProbeRequest) (*pb.ProbeResponse, error) {
	return &pb.ProbeResponse{}, nil
}

// Create backup of the provided volumes
func (server *lvmServer) StartBackup(ctx context.Context, req *pb.StartBackupRequest) (*pb.StartBackupResponse, error) {
	...
	log.Infof("Returned Backup Identifier %+v .... ", backupIdentifiers)
...
// Delete given backup
func (server *lvmServer) DeleteBackup(context.Context, *pb.DeleteBackupRequest) (*pb.DeleteBackupResponse, error) {
	return &pb.DeleteBackupResponse{}, nil
}

// Cancel given backup
func (server *lvmServer) CancelBackup(ctx context.Context, req *pb.CancelBackupRequest) (*pb.CancelBackupResponse, error) {
...
func (server *lvmServer) GetBackupStat(ctx context.Context,
...
func (server *lvmServer) CreateVolumeFromBackup(ctx context.Context,
...
func (server *lvmServer) CancelRestore(context.Context, *pb.CancelRestoreRequest) (*pb.CancelRestoreResponse, error) {
	return &pb.CancelRestoreResponse{}, nil
}

// Get restore statistics
func (server *lvmServer) GetRestoreStat(ctx context.Context, req *pb.GetRestoreStatRequest) (*pb.GetRestoreStatResponse, error) {
