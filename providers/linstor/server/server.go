...
type volBackupServer struct {
	ctx         context.Context
	options     options.LinstorProviderOptions
...
func NewVolumeBackupServer(ctx context.Context,
	serviceOptions options.LinstorProviderOptions) (pb.VolumeBackupServer, error) {
...
func NewIdentityServer(ctx context.Context,
	serviceOptions options.LinstorProviderOptions) pb.IdentityServer {
	return &volBackupServer{
		ctx:     ctx,
		options: serviceOptions,
	}
