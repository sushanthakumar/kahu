...
type VolumeSource struct {
	List []ResourceObjectReference `json:"list,omitempty" protobuf:"bytes,1,opt,name=list"`
...
type VolumeGroupSpec struct {
	Backup *ResourceObjectReference `json:"backup,omitempty" protobuf:"bytes,1,opt,name=backup"`
...
type VolumeGroupStatus struct {
	Volumes []ResourceObjectReference `json:"volumes,omitempty" protobuf:"bytes,1,opt,name=volumes"`
