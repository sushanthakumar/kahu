...
func NewControllerManager(ctx context.Context,
	...
	volumeHandle, err := volume.NewVolumeHandler(clientFactory)
	if err != nil {
		return nil, err
	}
	...
	csiSnapshoter, err := csi.NewSnapshotter(clientConfig,
		completeConfig.KubeClient, completeConfig.KahuClient, volSnapshotClassSyncer)
	if err != nil {
		return nil, err
	}
