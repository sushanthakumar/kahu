...
func NewController(
	...
	restoreController := &controller{
		...
		restoreVolumeClient:  kahuClient.KahuV1().VolumeRestoreContents(),
		restoreVolumeLister:  informer.Kahu().V1().VolumeRestoreContents().Lister(),
	...
	go newReconciler(defaultReconcileTimeLoop,
		...
		informer.Kahu().V1().VolumeRestoreContents().Lister(),
