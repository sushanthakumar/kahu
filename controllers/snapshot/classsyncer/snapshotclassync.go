...
const (
	...
	AnnSnapshotClassDefault = "kahu.io.snapshotclass/default"
)
...
type Interface interface {
	...
	SnapshotClassByVolume(volume kahuapi.ResourceObjectReference) (*snapshotapi.VolumeSnapshotClass, error)
}
...
func (syncer *snapshotClassSyncer) SnapshotClassByVolume(
	volume kahuapi.ResourceObjectReference) (*snapshotapi.VolumeSnapshotClass, error) {
	switch volume.Kind {
	case utils.PVC:
